...
Switches:
/LogFileFile:
Input $LogFile extracted. Required.
/MftCsvFile:
...
/SourceIsNt5x:
Boolean value for specifying if the volume is from an Nt5x system. Default is 0 (Nt6x). Can be 0 or 1.
/ExtractDataUpdates:
Boolean value for specifying if extraction of resident data content should be performed. Default is 0. Can be 0 or 1.
/ExtractDataUpdatesSize:
...
LogFileParser.exe /LogFileFile:c:\temp\$LogFile /TimeZone:7.00 /MftRecordSize:1024 /TSFormat:2 /TSPrecision:None /SourceIsNt5x:1
LogFileParser.exe /LogFileFile:c:\temp\$LogFile /TimeZone:7.00 /MftRecordSize:1024 /TSFormat:2 /TSPrecision:None /SourceIsNt5x:1 /SkipSqlite3:1
LogFileParser.exe /LogFileFile:c:\temp\$LogFile /OutputPath:E:\LFP-Output
LogFileParser.exe /LogFileFile:c:\temp\$LogFile
